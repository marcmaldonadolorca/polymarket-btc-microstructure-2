...
$\Delta_H = (m_{t+H} - m_t)/m_t$, donde $m_t$ es el precio medio del contrato. La etiqueta
direccional se obtiene con un umbral $\theta$ que absorbe el \emph{spread}, las comisiones
y el ruido: \textsc{up} si $\Delta_H > \theta$, \textsc{down} si $\Delta_H < -\theta$ y
\textsc{flat} en otro caso. Las características son causales (solo usan información hasta
...
más fiel que asumir un coste fijo e igual para todas las operaciones.
...
temporal (TCN) para el régimen de volatilidad. Estas arquitecturas aprenden representación,
pero no producen una política estable con un horizonte de entrenamiento de unas dos semanas
(unos 5\,800 ejemplos): el aprendizaje profundo se aparca a la espera de más datos.
...
a la apertura, con libro saludable y coste visible acotado. Ambas cabezas comparten una
