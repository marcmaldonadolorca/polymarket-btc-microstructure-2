...
Los datos de mercado se registran mediante una herramienta de captura desarrollada
específicamente para este trabajo, cuyo código forma parte del repositorio público
(Capítulo~\ref{ch::reproducibilidad}). Por cada sesión de mercado, la herramienta anota
cuatro tipos de información: (i) el libro de órdenes del contrato de Polymarket y su flujo de
operaciones; (ii) los metadatos del mercado (tamaño de tick, ventana temporal, comisiones);
(iii) referencias externas del mercado de Bitcoin —el mercado al contado (\emph{spot}) y los
futuros perpetuos (\emph{perpetual futures})—; y (iv) un oráculo de precios que aporta el
precio de referencia. La fuente de verdad es una base de datos relacional sobre la que se
construyen las características; el repositorio incluye el esquema de esa consulta y una
muestra representativa de los datos. Todas las fuentes se alinean en el tiempo sobre una
malla regular de dos segundos, como se detalla a continuación (Figura~\ref{fig:captura}).
